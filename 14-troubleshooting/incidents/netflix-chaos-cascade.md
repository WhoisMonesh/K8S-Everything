# Incident: Netflix Chaos Engineering Cascade (2020)

> **Category:** Incident Case Study / Stylized (based on chaos engineering failure patterns)
> **Severity:** S2 — partial outage during chaos experiment
...
|-------|--------|
| **Company** | Netflix |
| **Trigger** | Chaos Monkey experiment with insufficient blast radius controls |
