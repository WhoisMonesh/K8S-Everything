# Migration Guide: Self-Managed to Managed Kubernetes

> **Category:** Operations / Migration
> Step-by-step guide for migrating from self-managed to managed Kubernetes.

## Overview

```mermaid
graph LR
    A[Self-Managed Cluster] --> B[Assess Workloads]
...
```bash
# Scale down self-managed workloads
...
| Issue | Cause | Fix |
|-------|-------|-----|
| Storage not migrating | Different provisioner | Create matching StorageClass |
...
| Cleanup | Remove self-managed cluster after validation |
...
- [Bare-Metal to Cloud Migration](migration-bare-metal-to-cloud.md)
